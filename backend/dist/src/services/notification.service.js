...
const notificationService = {
    ...
    createWelcome(userId) {
        return this.create("WELCOME", "Welcome to Flash", "You have successfully created your account.", userId);
    },
    createReset(userId) {
        return this.create("SUCCESS", "Profile reset", "Your profile has been reset. Please buy a stock to start trading.", userId);
    },
    createWarning(userId, symbol, direction) {
        const title = direction === "profit" ? "Profit Alert!" : "Loss Alert!";
        const content = direction === "profit"

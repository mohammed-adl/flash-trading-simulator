...
export const getPortfolio = asyncHandler(async (req, res) => {
    ...
    const { totalDeposits = 0, totalWithdrawals = 0 } = await redisService.getTransactions(userId);
    ...
    const { largestWin = 0, largestLoss = 0, avgWin = 0, avgLoss = 0, lastTrade = null, totalSharesTraded = 0, winRate = 0, } = tradeStats;
    const stats = {
        totalDeposits,
        totalWithdrawals,
        monthlyRealizedPnL,

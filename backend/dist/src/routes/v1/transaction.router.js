...
router.post("/deposit", validate({ body: depositBodySchema }), transactionController.deposit);
router.post("/withdraw", validate({ body: withdrawBodySchema }), transactionController.withdraw);
